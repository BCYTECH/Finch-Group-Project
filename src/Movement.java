...
public class Movement extends Main{
	...
	public void Forward()
	{
		...
		myfi.setWheelVelocities(myfi.getRightLightSensor()-10,myfi.getLeftLightSensor()-10);
	...
	public void Left()
	{
		...
		myfi.setWheelVelocities(myfi.getRightLightSensor()-50,myfi.getLeftLightSensor()-5);
	...
	public void Right()
	{
		...
		myfi.setWheelVelocities(myfi.getRightLightSensor()-5,myfi.getLeftLightSensor()-50);
